...
from scrapy.contrib.downloadermiddleware.httpdigest import HttpDigestMiddleware
...
class HttpDigestMiddlewareTest(unittest.TestCase):

    def setUp(self):
        self.mw = HttpDigestMiddleware()
